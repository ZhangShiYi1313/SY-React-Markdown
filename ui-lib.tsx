...
import React, { CSSProperties, HTMLProps, MouseEvent, useEffect, useState, useCallback, useRef } from 'react';
...
export function ListItem(props: {
  ...
  return (
    <div
      className={styles['list-item'] + ` ${props.vertical ? styles['vertical'] : ''} ` + ` ${props.className || ''}`}
  ...
  return (
    <div ref={ref} style={{ position: 'relative' }} {...rest}>
      <div style={{ position: 'absolute', right, top }}>
        <IconButton icon={fullScreen ? <MinIcon /> : <MaxIcon />} onClick={toggleFullscreen} bordered />
      </div>
      {children}
    </div>
  );
