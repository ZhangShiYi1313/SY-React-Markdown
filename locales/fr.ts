...
const fr: PartialLocaleType = {
  ...
  Settings: {
    ...
    FontFamily: {
      ...
      SubTitle: 'Police du contenu du chat, laissez vide pour appliquer la police par défaut globale',
  ...
  NewChat: {
    ...
    ConfirmNoShow: 'Confirmez-vous vouloir désactiver cela? Vous pouvez le réactiver plus tard dans les paramètres.',
  },
